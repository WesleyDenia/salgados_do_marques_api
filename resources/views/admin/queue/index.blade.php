...
@section('content')
  <div style="display:grid; gap:24px;">
    ...
    <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(180px, 1fr)); gap:18px;">
      ...
      <div class="card">
        <div style="font-size:0.85rem; text-transform:uppercase; letter-spacing:0.08em; color:#9ca3af;">Cupons com erro</div>
        <div style="font-size:2rem; font-weight:700; margin-top:8px;">{{ $stats['coupon_imports_failed'] }}</div>
      </div>
    </div>
